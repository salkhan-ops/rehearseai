  ...
  return (
    <div className="rounded-[1.25rem] bg-white p-5 shadow-[0_14px_38px_rgba(35,45,75,0.045)] ring-1 ring-slate-200/75">
      <div className="grid gap-3 md:grid-cols-3">
        ...
        <input aria-label="Monthly price" placeholder="Monthly price" value={draft.priceMonthly} type="number" onChange={(e) => setDraft({ ...draft, priceMonthly: Number(e.target.value) })} className="rounded-2xl border border-slate-200 px-4 py-3 font-semibold outline-none" />
