...
const sections = [
  ...
  ["Camera-Assisted Timing", "Camera-assisted timing is optional and off by default. If enabled, camera video is processed locally in your browser to create numeric communication timing signals that help pause management and turn-taking. Video is not recorded, uploaded, or stored, and images or frames are not stored. Only numeric communication timing signals may be stored if you separately allow local-signal telemetry. You can disable camera-assisted timing anytime, and raw video storage is not supported by default."],
