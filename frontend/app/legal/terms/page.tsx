...
const sections = [
  ...
  ["Eligibility", "You must be old enough to form a binding contract in your jurisdiction and to use online services. If you use RehearseAI on behalf of an organization, you represent that you have authority to bind that organization."],
