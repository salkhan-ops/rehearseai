...
DEFAULT_PLANS = [
    {"planId": "free", "slug": "free", "name": "Free", "description": "5 sessions/month, basic feedback, limited history.", "priceMonthly": 0, "priceYearly": 0, "currency": "USD", "paddleProductId": "", "paddleMonthlyPriceId": "", "paddleYearlyPriceId": "", "isActive": True, "isPublic": True, "sortOrder": 1, "entitlements": DEFAULT_ENTITLEMENTS},
    {"planId": "pro", "slug": "pro", "name": "Pro", "description": "20 sessions/month, advanced reports, history, shareable reports, decision trees, and challenge mode.", "priceMonthly": 19, "priceYearly": 149, "currency": "USD", "paddleProductId": "", "paddleMonthlyPriceId": "", "paddleYearlyPriceId": "", "isActive": True, "isPublic": True, "sortOrder": 2, "entitlements": {**DEFAULT_ENTITLEMENTS, "maxSessionsPerMonth": 20, "maxMessagesPerSession": 40, "maxSessionMinutes": 45, "allowBrutalMode": False, "allowNerveMode": False, "allowChallengeMode": True, "allowAdvancedAnalytics": True, "allowDecisionTree": True, "allowHistoricalTrends": True, "allowShareableReports": True, "allowReportExport": True, "allowLongitudinalMemory": True, "allowCourseTemplates": False, "reportDepth": "advanced", "historyRetentionDays": 365, "monthlyGeminiTokenLimit": 300000, "docGroundingDocsPerDay": 3}},
    {"planId": "coach", "slug": "coach", "name": "Coach", "description": "45 sessions/month, Brutal & Nerve pressure modes, advanced personas, benchmarking, priority features, extended history, and advanced replay intelligence.", "priceMonthly": 29, "priceYearly": 229, "currency": "USD", "paddleProductId": "", "paddleMonthlyPriceId": "", "paddleYearlyPriceId": "", "isActive": True, "isPublic": True, "sortOrder": 3, "entitlements": {**DEFAULT_ENTITLEMENTS, "maxSessionsPerMonth": 45, "maxMessagesPerSession": 80, "maxSessionMinutes": 90, "allowBrutalMode": True, "allowNerveMode": True, "allowChallengeMode": True, "allowAdvancedAnalytics": True, "allowDecisionTree": True, "allowHistoricalTrends": True, "allowBenchmarking": True, "allowShareableReports": True, "allowReportExport": True, "allowLongitudinalMemory": True, "allowCustomPersonas": True, "allowCourseTemplates": False, "reportDepth": "coach", "historyRetentionDays": "unlimited", "monthlyGeminiTokenLimit": 1200000, "docGroundingDocsPerDay": "unlimited"}},
]

DEFAULT_PRODUCTS = [
    {"productId": "free-interview-practice", "title": "Free Interview Practice", "slug": "free-interview-practice", "description": "Starter interview rehearsal with basic feedback.", "category": "practice", "linkedPlanId": "free", "linkedTemplateId": "", "priceDisplay": "$0", "badgeText": "Starter", "isFeatured": False, "isPublic": True, "sortOrder": 1, "heroText": "Practice your first interview loop.", "benefits": ["5 sessions/month", "Basic feedback"], "limitations": ["Limited reports"], "ctaText": "Start free", "ctaUrl": "/practice",},
    {"productId": "pro-interview-pressure-training", "title": "Pro Interview Pressure Training", "slug": "pro-interview-pressure-training", "description": "Adaptive interview pressure with advanced analytics.", "category": "practice", "linkedPlanId": "pro", "linkedTemplateId": "job-interview-product-manager", "priceDisplay": "$19/mo", "badgeText": "Popular", "isFeatured": True, "isPublic": True, "sortOrder": 2, "heroText": "Train under realistic pressure.", "benefits": ["20 sessions/month", "Advanced reports", "Challenge mode"], "limitations": [], "ctaText": "Upgrade to Pro", "ctaUrl": "/pricing",},
    {"productId": "reasoning-under-pressure-30", "title": "30-Day Reasoning Under Pressure", "slug": "reasoning-under-pressure-30", "description": "A structured course for calm, evidence-backed reasoning.", "category": "course", "linkedPlanId": "coach", "linkedTemplateId": "reasoning-under-pressure-30", "priceDisplay": "$29/mo", "badgeText": "Coach", "isFeatured": True, "isPublic": True, "sortOrder": 3, "heroText": "Build durable reasoning under pressure.", "benefits": ["Daily missions", "Progressive pressure", "Reasoning map"], "limitations": [], "ctaText": "Open course", "ctaUrl": "/courses",},
]
